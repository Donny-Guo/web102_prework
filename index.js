...
const totalBackersCount = GAMES_JSON.reduce((total, game) => total + game.backers, 0);

// set the inner HTML using a template literal and toLocaleString to get a number with commas
contributionsCard.innerHTML = `${totalBackersCount.toLocaleString('en-US')}`;
...
gamesCard.innerHTML = `${totalGamesCount.toLocaleString('en-US')}`;
